...
class OkHttpStvrClientTest {
    @Test
    fun `returns final URL after STVR redirect`() = runBlocking {
        val finalUrl = "https://www.stvr.sk/televizia/archiv/14029/620563"
        ...
        assertEquals(
            ...
            OkHttpStvrClient(okHttpClient).finalUrl(
                "https://www.stvr.sk/televizia/program/14029/620563",
                emptyMap(),
            ),
        )
    }
